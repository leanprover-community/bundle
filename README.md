...
confirming that key UI surfaces work. Generated by Tier 6 Playwright tests
and uploaded as CI artifacts (`tier6-screenshots`).

- **Infoview rendering**: Editor with a Lean proof open, infoview panel showing
  goal state (hypotheses and conclusion)
- **Live diagnostics**: Editor showing error feedback after typing, with
